import "../ArañasPortacontenedores/ArañasPortacontenedores.css";
    ...
    <div>
      ...
      <div>
        <div className="titleSpecificFlota">
          <h1>TRANSPORTE DE AUTOMOVILES</h1>
        </div>
        <div className="containerFatherFlota">
          ...
          <div className="descriptionProductFlota">
            <h2>Transporte De Automoviles</h2>
            <p>
...
export default TransporteDeAutomoviles;
